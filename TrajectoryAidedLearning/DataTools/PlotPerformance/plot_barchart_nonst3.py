...
# Classic One
data_means = np.array([
              [[0.5382, 17.4889, 1.6627, 6.4889]],
               
              [[0.5909, 17.4650, 1.6245, 7.6300]],
             ])
data_stds = np.array([
              [[0.0450, 1.8260, 0.1279, 2.4660]],
               
              [[0.0704, 5.0403, 0.1035, 4.7547]],
             ])
...
std_img_saving("Data/Vehicles/classic_1_barplot", grid=False)