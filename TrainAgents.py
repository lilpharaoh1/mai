...
from TrajectoryAidedLearning.Planners.DirectorPlanners import DirectorTrainer, DirectorTester
...
def select_agent(run, conf, architecture, train=True):
    ...
    if agent_type == "PP":
        ...
        agent = DirectorTrainer(run, conf) if train else DirectorTester(run, conf)
